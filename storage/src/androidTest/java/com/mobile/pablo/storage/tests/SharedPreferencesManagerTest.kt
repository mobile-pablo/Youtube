...
class SharedPreferencesManagerTest {
    ...
    // String
    @Test
    fun setString_savesValueToSharedPreferences() = runBlocking {
    ...
    fun getString_throwsIllegalArgumentException_whenSettingTypeIsNotString(): Unit = runBlocking {
        val setting = Setting.TEST_BOOL
        sharedPreferencesManager.getString(setting)
    }

    @Test(expected = IllegalArgumentException::class)
    fun setString_throwsIllegalArgumentException_whenSettingTypeIsNotString(): Unit = runBlocking {
        val setting = Setting.TEST_BOOL
        sharedPreferencesManager.setString(setting, "value")
    }
    ...
    // Bool
    @Test
    fun setBool_savesValueToSharedPreferences() = runBlocking {
        val setting = Setting.TEST_BOOL
    ...
    @Test(expected = IllegalArgumentException::class)
    fun getBool_throwsIllegalArgumentException_whenSettingTypeIsNotBool(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setBool(setting, false)
    }

    @Test(expected = IllegalArgumentException::class)
    fun setBool_throwsIllegalArgumentException_whenSettingTypeIsNotBool(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setBool(setting, false)
    }
    ...
    // Int
    @Test
    fun setInt_savesValueToSharedPreferences() = runBlocking {
    ...
    @Test(expected = IllegalArgumentException::class)
    fun getInt_throwsIllegalArgumentException_whenSettingTypeIsNotInt(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setInt(setting, 1)
    }

    @Test(expected = IllegalArgumentException::class)
    fun setInt_throwsIllegalArgumentException_whenSettingTypeIsNotInt(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setInt(setting, 1)
    }
    ...
    // Long
    @Test
    fun setLong_savesValueToSharedPreferences() = runBlocking {
    ...
    @Test(expected = IllegalArgumentException::class)
    fun getLong_throwsIllegalArgumentException_whenSettingTypeIsNotLong(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setLong(setting, 1L)
    }

    @Test(expected = IllegalArgumentException::class)
    fun setLong_throwsIllegalArgumentException_whenSettingTypeIsNotLong(): Unit = runBlocking {
        val setting = Setting.TEST_STRING
        sharedPreferencesManager.setLong(setting, 1L)
    }
}